...
import { CheckIcon, DeleteIcon, Plane, PlayCircle, StarIcon } from "lucide-react"
import { kConverter } from "../../lib/kConverter"

const AddShows = () => {
  const currency = import.meta.env.VITE_CURRENCT
  ...
  return nowPlayingMovies.length > 0 ? (
    <>
      ...
      <div className="mt-8">
        ...
        px-3 py-2 rounded-md">
          ...
          <input type="number" min={0} value={showPrice} onChange={(e) =>
            setShoPrice(e.target.value)} placeholder="Enter Show Price" className='outline-none' />
        </div>
      </div>
      ...
      <button className="bg-primary text-white px-8 py-2 mt-6 rounded hover:bg-primary/90 transition-all cursor-pointer font-semibold">
        Add Show
      </button>
