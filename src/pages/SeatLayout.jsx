...
import { ArrowBigDown, ArrowRightIcon, ClockIcon } from 'lucide-react';
...
const SeatLayout = () => {
  ...
  const getShow = async () => {
    const trimmedId = id.trim(); // ลบ space ข้างหน้า-ข้างหลัง
    const show = dummyShowsData.find(show => show._id === trimmedId)
  ...
  return show ? (
    ...
    md:pt-50'>
      ...
      {/* Seats Layout */}
      <div className='relative flex-1/2 flex flex-col items-center max-md:mx-16'>
